...
class AddColumnsInProducts extends Migration
{
    ...
    public function up()
    {
        Schema::table('products', function (Blueprint $table) {
            $table->text('crawl_url')->nullable();
            $table->enum('crawl_site',['esiso','esaitech','techbuyer','serversupply','tigerdirect','mkbtechnology','globalonetechnology','manual'])->default('manual');
