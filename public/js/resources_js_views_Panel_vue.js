...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    exportbrands: function exportbrands() {
      axios.get('api/export-brands').then(function (e) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Export Report Submitted', 'Brands Will be exported in a bit, you will be notified', 'success');
      });
    },
    exportcategories: function exportcategories() {
      axios.get('api/export-categories').then(function (e) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Export Report Submitted', 'Categories Will be exported in a bit, you will be notified', 'success');
      });
    },
    exportproduct: function exportproduct() {
      axios.get('api/export-products').then(function (e) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Export Report Submitted', 'Products Will be exported in a bit, you will be notified', 'success');
      });
    }
  },
        ...
        [
          _c(
            "v-btn",
            {
              ...
              on: { click: _vm.exportbrands },
            },
            [_vm._v("Export Brands")]
          ),
        ],
        1
      ),
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              attrs: { elevation: "2", color: "primary" },
              on: { click: _vm.exportcategories },
            },
            [_vm._v("Export Category")]
          ),
        ],
        1
      ),
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              attrs: { elevation: "2", color: "primary" },
              on: { click: _vm.exportproduct },
            },
            [_vm._v("Export Product")]
          ),
        ],
        1
      ),
