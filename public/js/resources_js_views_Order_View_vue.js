...
/* harmony import */ var _services_auth_orders__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @services/auth/orders */ "./resources/js/services/auth/orders.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return service.get(_this2.$route.params.id).then(function (e) {
                  _this2.loading = false;
                  _this2.order_status = e.order_status;
                  return e;
                });
    ...
    updateRowQantity: function updateRowQantity(item) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _services_auth_orders__WEBPACK_IMPORTED_MODULE_2__["default"].updateQty(_this3.invoice.id, _this3.selectedItem);

              case 2:
                _this3.updateQtyModal = false;
    ...
    chargeCustomer: function chargeCustomer() {
      var _this4 = this;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                _context4.next = 6;
                return _services_auth_orders__WEBPACK_IMPORTED_MODULE_2__["default"].captureOrder(_this4.invoice.id);

              case 6:
                res = _context4.sent;

                if (!res.status) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire("Error!", res.data, "error");
                } else {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire("Success!", "Your order has been charged.", "success");
                }
    ...
    voidCustomer: function voidCustomer() {
      var _this5 = this;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                _context5.next = 6;
                return _services_auth_orders__WEBPACK_IMPORTED_MODULE_2__["default"].voidOrder(_this5.invoice.id);
              ...
              case 6:
                ...
                if (!res.status) {
                  ...
                  sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire("Success!", "Your order has been voided.", "success");
                }
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return service.update(formData, _this6.invoice.id);
...
/***/ "./resources/js/services/auth/orders.js":
/*!**********************************************!*\
  !*** ./resources/js/services/auth/orders.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ordersservice = /*#__PURE__*/function () {
  ...
  _createClass(ordersservice, [{
    key: "updateQty",
    value: function () {
      var _updateQty = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(oid, item) {
        var res;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios.post('/api/update-qty/' + item.id, item).then(function (e) {
                  return {
                    status: 1,
                    data: e.data.data
                  };
    ...
    key: "getStripeIntentDetails",
    value: function () {
      var _getStripeIntentDetails = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(oid) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", axios.get("/api/order-stripedetails/".concat(oid)).then(function (response) {
                  return response.data;
                })["catch"](function (error) {
                  return error;
                }));
      ...
      function getStripeIntentDetails(_x3) {
        return _getStripeIntentDetails.apply(this, arguments);
      }

      return getStripeIntentDetails;
    }()
  }, {
    key: "captureOrder",
    value: function () {
      var _captureOrder = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(oid) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", axios.get("/api/capture-order/".concat(oid)).then(function (response) {
                  return response.data;
                })["catch"](function (error) {
                  return error;
                }));
      ...
      function captureOrder(_x4) {
        return _captureOrder.apply(this, arguments);
      }
    ...
    key: "voidOrder",
    value: function () {
      var _voidOrder = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4(oid) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt("return", axios.get("/api/void-order/".concat(oid)).then(function (response) {
                  return response.data;
                })["catch"](function (error) {
                  return error;
                }));
      ...
      function voidOrder(_x5) {
        return _voidOrder.apply(this, arguments);
      }
    ...
    [
                                    ...
                                    [
                                      _c(
                                        "v-btn",
                                        {
                                          ...
                                          on: {
                                            click: function ($event) {
                                              return _vm.updateRowQantity(item)
                                            },
                                          },
                                        },
                                        [_vm._v("Update Quantity")]
                                      ),
                                    ],
                                    1
                                  ),
      ...
      _c(
        "v-dialog",
        {
          ...
          model: {
            value: _vm.updateQtyModal,
            callback: function ($$v) {
              _vm.updateQtyModal = $$v
            },
            expression: "updateQtyModal",
          },
        },
        [
          _c(
            ...
            [
              _c("v-card-title", [
                _c("span", { staticClass: "text-h5" }, [
                  _vm._v("Update Order Product Quantity"),
                ]),
              ]),
              _vm._v(" "),
              _c(
                            ...
                            [
                              _c("v-text-field", {
                                ...
                                model: {
                                  ...
                                  callback: function ($$v) {
                                    _vm.$set(_vm.selectedItem, "quantity", $$v)
                                  },
